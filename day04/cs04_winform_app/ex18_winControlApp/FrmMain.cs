...
namespace ex18_winControlApp
{
    public partial class FrmMain : Form
    {
        ...
        public FrmMain()
        {
            ...
            GrbEditor.Text = "텍스터에디터"; // 코드비하인드 다자인셋팅
        }
        ...
        void ChangeFont()
        {
            ...
            if (ChkBold.Checked) // 굵게 체크 박스 체크하면
        ...
        private void TreeToList(TreeNode node)
        {
            ...
            LsvDummy.Items.Add(new ListViewItem(new string[] { node.Text, node.FullPath.Count(f => f == '\\').ToString() }));
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            // 모달리스창을 부모 정중앙에 위치할때는 아래와 같이 작업해야 함
        ...
        private void BtnFileLoad_Click(object sender, EventArgs e)
        {
            ...
            {
                // UTF-8이 한글이 깨짐. EUC_KR(Window949), UTF-8(BOM)은 한글이 문제 없음.
