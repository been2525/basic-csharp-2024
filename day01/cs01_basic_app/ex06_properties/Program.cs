namespace ex06_properties
{
    class Kiturami
    {
        ...
        //    if(temp > 70)
        //    {
        //        Console.WriteLine("온도가 너무 높습니다. 50도로 조정합시다!");
        //        this.temperature = 50;
        //    }else if (temp < 10)
        //    {
        //        Console.WriteLine("온도가 너무 낮습니다. 20도로 조정합시다!");
        //        this.temperature = 20;
        //    }else
        //    {
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //boiler.SeTemperature(400); // Getter/Setter메서드로 구현한 방법
